...
<%@ include file="/WEB-INF/jsp/pels/include/common.jspf"%>
	<script>
		...
		function fncSave () {
			...
			formData.append('BLBR_UNQ_KY_VAL', '${BLBR_UNQ_KY_VAL}'); 
			...
			<div class="page-content-area">
				...
				<div class="page-header">
					<h1>
						...
						<span class="title">고장신고 및 개선의견 수정</span>
						</c:if>
						<c:if test="${GRUP_CFY_CD eq 'B'}">
						<span class="title">자료실 수정</span>
						</c:if>
						...
						<span>
							<ul class="breadcrumb">
								<li>
									...
									<c:if test="${GRUP_CFY_CD eq 'A'}">
										<li class="active">개선사항 및 고장신고 수정</li>
									</c:if>
									<c:if test="${GRUP_CFY_CD eq 'B'}">
										<li class="active">자료실 수정</li>
									</c:if>
									<c:if test="${GRUP_CFY_CD eq 'C'}">
								...
								<div class="ContentPanel">
									<div class="GridWrite">       
                                        ...
                                        <tr class="Row">
                                            ...
                                            <td class="Value">
												<input name="BLBR_TITL_NM" id="BLBR_TITL_NM" title="제목" type="text" class="TextBox" value="${boardDetail.BLBR_TITL_NM}" style="width:850px;" required />
											</td>
                                        </tr>
                                        <tr class="Row">
                                            <th class="Title"><span class="Label ">내용</span></th>
                                            <td class="Value"><textarea name="BLBR_CTT" id="BLBR_CTT" title="내용" rows="20" cols="150" required>${boardDetail.BLBR_CTT}</textarea>
											</td>
                                          </tr>
										<c:choose>
											<c:when test="${null ne boardDetail.FNAME1}">
		                                        ...
		                                        <tr class="Row">
		                                            <th class="Title" row=2><span class="Label"></span></th>
