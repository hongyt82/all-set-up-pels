...
<%@ include file="/WEB-INF/jsp/pels/include/common.jspf"%>
	<script>
		...
		function MM_openBrWindow(theURL,winName,features, flag) {
          ...
          console.log('[Exam_Input_M2] Before MM_openBrWindow clicked', {
          ...
          if(!SH_DOC_TYP_CD || !SH_PRCDOC_NO || !SH_PRT_NO){
             console.log('[Exam_Input_M2] After MM_openBrWindow clicked', {
                  SH_DOC_TYP_CD: SH_DOC_TYP_CD,
                  SH_PRCDOC_NO: SH_PRCDOC_NO,
                  SH_PRT_NO: SH_PRT_NO
             });
            alert("=============빈칸 허용 안함 Exam_Input_M2.jsp ===========");
            return;
          }
	  ...
	  <script>
	    ...
	    function sendInputRequestWithAck() {
	      var current = document.getElementById('sampleInputAck').value;
            if (window.PelsAndroidBridge && PelsAndroidBridge.input && PelsAndroidBridge.input.requestWithAck) {
                ...
                // 여기는 그냥 PC 브라우저에서 호출한 경우
                alert("--------sendInputRequestWithAck------")
            }
	    }
	
	    function sendApiRequestWithAck() {
            if (window.PelsAndroidBridge && PelsAndroidBridge.api && PelsAndroidBridge.api.callWithAck) {
		...
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
							...
							<div class="Default">
								<table border="0" cellpadding="0" cellspacing="0" class="Outline">
									...
									<tr>
										...
										<td class="Value">
			                            <input type="text" class="TextBox" name="SH_DOC_TYP_CD" id="SH_DOC_TYP_CD" value="FP0" style="width:100px;" inputmode="text" enterkeyhint="next" autocomplete="off" autocapitalize="off" />
										</td>
										<td class="Title"><span class="Label">문서번호</span></td>
										<td class="Value">
			                            	<input type="text" class="TextBox" name="SH_PRCDOC_NO" id="SH_PRCDOC_NO" value="" style="width:100px;" inputmode="text" enterkeyhint="next" autocomplete="off" autocapitalize="off" />
										</td>
										<td class="Title"><span class="Label">문서부분</span></td>
										<td class="Value">
			                                <input type="text" class="TextBox" name="SH_PRT_NO" id="SH_PRT_NO" value="" style="width:100px;" inputmode="text" enterkeyhint="done" autocomplete="off" autocapitalize="off" />
										</td>
									</tr>
								</table>
					...
					<!-- PAGE CONTENT BEGINS -->	
					<div class="RealPanel" style="display:none">
							<div class="Title">
								<div class="TitleArea">
								...
								<div class="GridWrite">       
									<table cellspacing="0" cellpadding="0" border="0" class="Outline">
                                                 <tr class="Row">
                                                     ...
                                                     <td class="Value"><input name="PRCDOC_TITL" id="PRCDOC_TITL" title="절차서명" type="text" class="TextBox" style="width:95%;" readonly ></td>
                                                 </tr>
                                                 <tr class="Row">
											...
											<a class="IconButton"><span class='Calendar' onclick="fncDatePicker('CHCK_END_DT')">&nbsp;</span><span class='Text'>&nbsp;</span></a>
                                                     ...
                                                     <td class="Value"><input name="TITL_NM" id="TITL_NM" title="제목명" type="text" class="TextBox" style="width:95%;" required>
											</td>
                                                 </tr>
                                                 <tr class="Row">
