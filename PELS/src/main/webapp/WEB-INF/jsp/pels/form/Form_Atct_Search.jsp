...
<%@ include file="/WEB-INF/jsp/pels/include/common.jspf"%>
	<script>
		...
		function fnFormInput () {
			...
			form.action = "Form_Atct_Input.do"
			form.submit()
		}
		...
		function fnFormDetail() {
			...
			let form = document.getElementById('form')
			form.action = "Form_Atct_Detail.do?FRM_UNQ_KY_VAL=" + chkParam;
			form.submit()
		}
		
		// 관리항목 화면으로 이동
		function fnFormManageSearch(FRM_UNQ_KY_VAL, ATCT_CFY) {
			let form = document.getElementById('form')
			form.FRM_UNQ_KY_VAL.value = FRM_UNQ_KY_VAL
			form.ATCT_CFY.value = ATCT_CFY
		...
		function fnSearch () {
			let form = document.getElementById('form')
			form.action = "Form_Atct_Search.do"
			form.submit()
		}
	...
	<body class="no-skin real-skin">
			...
			<input type="hidden" name="FRM_UNQ_KY_VAL" id="FRM_UNQ_KY_VAL" vlaue="">
			<input type="hidden" name="ATCT_CFY" id="ATCT_CFY" vlaue="">
				<div class="page-content">
					<div class="page-content-area">
						<!-- #ection:basics/page-header -->
						<div class="page-header">
							<h1>
								<span class="title">점검관리(붙임)</span>
								<span>
									<ul class="breadcrumb">
										<li>
											<a href="#">절차서(서식)관리</a>
										</li>
										<li class="active">점검관리(붙임)</li>
									</ul><!-- /.breadcrumb -->
								</span>
							</h1>
						</div><!-- /page-header -->
						...
						<div class="PageButtonGroup" style="text-align:right">
							<!-- <a class="btn-m" href="javascript:fnFormManageSearch();"><span class="Text">관리항목</span></a> -->
											...
											<table cellspacing="0" cellpadding="0" border="0" class="Outline">
												...
												<c:forEach var="form" items="${formList}" begin="0" end="${formList.size()}" step="1">
													<tr class="Item">
														...
														<td align="center">${form.ATCT_NM}</td>
														...
														<td align="center"><a href="javascript:fnFormManageSearch(${form.FRM_UNQ_KY_VAL},'${form.ATCT_CFY}');" class="SubButton"><span class="Text">관리항목</span></a></td>
