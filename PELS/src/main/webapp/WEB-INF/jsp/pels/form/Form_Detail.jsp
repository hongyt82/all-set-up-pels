			...
			$.ajax({
				...
				success: function (resultData) {
					...
					if('true' == resultData.resultCd) {
						...
						location.href = '/Form_Detail.do?FRM_UNQ_KY_VAL=' + $('#FRM_UNQ_KY_VAL').val();
					} else {
										...
										<colgroup>
											...
											<col style="width:40%" />
                                                  ...
                                                  <tr class="Row">
                                                      ...
                                                      <td class="Value">
														<input name="DOC_TYP" id="DOC_TYP" title="문서유형" type="text" class="TextBox" value="" style="width:100px;" readonly/>
													  </td>
