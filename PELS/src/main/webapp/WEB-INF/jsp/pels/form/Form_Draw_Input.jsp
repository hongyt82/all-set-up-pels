				...
				<div class="page-content">
					<div class="page-content-area">
						...
						<div class="page-header">
							<h1>
								<span class="title">도면연계관리 입력</span>
								<span>
									<ul class="breadcrumb">
										<li>
											<a href="#">절차서(서식)관리</a>
											...
											<div class="GridWrite">       
												...
												<colgroup>
                                                    ...
                                                    <tr class="Row">
                                                        ...
                                                        <td class="Value">
															<input name="FRM_ID" id="FRM_ID" title="이폼서식ID" type="text" class="TextBox" value="" style="width:90%;" required />
														</td>
                                                        <th class="Title"><span class="Label Req">문서번호</span> </th>
                                                        <td class="Value">
															<input name="DOC_UNQ_ID" id="DOC_UNQ_ID" title="문서번호" type="text" class="TextBox" value="" style="width:90%" required />
														</td>
                                                    </tr>
                                                    <tr class="Row">
                                                        <th class="Title"><span class="Label Req">문서유형</span></th>
                                                        <td class="Value">
															<input name="DOC_TYP" id="DOC_TYP" title="문서유형" type="text" class="TextBox" value="${DOC_TYP}" style="width:100px;" required/>
														</td>
                                                        <th class="Title"><span class="Label Req">문서부분코드</span> </th>
                                                        <td class="Value">
															<input name="DOC_PART_CD" id="DOC_PART_CD" title="문서부분코드" type="text" class="TextBox" value="${DOC_PART_CD}" style="width:100px;" required/>
														</td>
                                                    </tr>
                                                </table>
											</div>			
