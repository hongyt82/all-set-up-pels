											...
											<div class="GridWrite">       
												...
												<colgroup>
                                                    ...
                                                    <tr class="Row">
                                                        ...
                                                        <td class="Value">
															<input name="FRM_ID" id="FRM_ID" title="서식ID" type="text" class="TextBox" value="" style="width:200px;" required />
														</td>
                                                        <th class="Title"><span class="Label Req">제목</span> </th>
                                                        <td class="Value">
															<input name="TITL_NM" id="TITL_NM" title="제목명" type="text" class="TextBox" value="" style="width:90%;" required />
														</td>
                                                    </tr>
                                                    <tr class="Row">
                                                        <th class="Title"><span class="Label">1번째항목명</span></th>
                                                        <td class="Value">
															<input name="TH1_ITM_NM" id="TH1_ITM_NM" title="1번째항목명" type="text" class="TextBox" value="" style="width:90%;" />
														</td>
                                                        <th class="Title"><span class="Label">2번째항목명</span> </th>
                                                        <td class="Value">
															<input name="TH2_ITM_NM" id="TH2_ITM_NM" title="2번째항목명" type="text" class="TextBox" value="" style="width:400px;" />
														</td>
                                                    </tr>
                                                    <tr class="Row">
                                                        <th class="Title"><span class="Label">3번째항목명</span></th>
                                                        <td class="Value">
															<input name="TH3_ITM_NM" id="TH3_ITM_NM" title="3번째항목명" type="text" class="TextBox" value="" style="width:90%;" />
														</td>
                                                        <th class="Title"><span class="Label">기준치값설명</span> </th>
                                                        <td class="Value">
															<input name="STDVL_VAL_NM" id="STDVL_VAL_NM" title="기준치값설명" type="text" class="TextBox" value="" style="width:150px;"/>
														</td>
                                                    </tr>
                                                    <tr class="Row">
                                                        <th class="Title"><span class="Label">단위</span></th>
                                                        <td class="Value">
                                                        	<input name="UNIT_NM" id="UNIT_NM" title="단위" type="text" class="TextBox" value="" style="width:200px;"/>
														</td>
                                                        ...
                                                        <td class="Value">
															<select name="CNIF_YN" id="CNIF_YN" title="연계여부" style="width:100px;">
																...
																<option value="N" selected>미연계</option>
															</select>															
															연계태그명 <input name="CNIF_TAG_NM" id="CNIF_TAG_NM" title="연계태그명" type="text" class="TextBox" value="" style="width:200px;"/>
														</td>
                                                    </tr>
                                                </table>
											</div>			
