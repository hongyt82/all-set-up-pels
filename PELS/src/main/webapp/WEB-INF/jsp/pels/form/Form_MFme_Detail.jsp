			...
			$.ajax({
				...
				success: function (resultData) {
					...
					if('true' == resultData.resultCd) {
						...
						location.href = '/Form_Manage_Search.do?FRM_UNQ_KY_VAL=' + $('#FRM_UNQ_KY_VAL').val() + '&ATCT_CFY=${ATCT_CFY}';
					} else {
						alert('저장에 실패하였습니다.');
				...
				<div class="page-content">
					<div class="page-content-area">
						...
						<div class="page-header">
							<h1>
								<span class="title">비상샤워기 및 세안설비 점검 수정</span>
								<span>
									<ul class="breadcrumb">
										<li>
											<a href="#">절차서(서식)관리</a>
										...
										<li class="active">비상샤워기 및 세안설비 점검 수정</li>
									</ul><!-- /.breadcrumb -->
								</span>
							</h1>
						</div><!-- /page-header -->
											...
											<div class="GridWrite">       
												...
												<colgroup>
                                                    ...
                                                    <tr class="Row">
                                                        ...
                                                        <td class="Value">
															<input name="TH1_ITM_NM" id="TH1_ITM_NM" title="중분류" type="text" class="TextBox" value="${TH1_ITM_NM}" style="width:90%;" required/>
														</td>
                                                    </tr>
                                                </table>
											</div>			
