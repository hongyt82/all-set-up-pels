				...
				<div class="page-content">
					<div class="page-content-area">
						...
						<div class="page-header">
							<h1>
								<span class="title">비상샤워기 및 세안설비 점검 등록</span>
								<span>
									<ul class="breadcrumb">
										<li>
											<a href="#">절차서(서식)관리</a>
                                        ...
                                        <li>
                                            <a href="/Form_Manage_Search.do?FRM_UNQ_KY_VAL=${FRM_UNQ_KY_VAL}">비상샤워기 및 세안설비 점검</a>
                                        </li>
										<li class="active">비상샤워기 및 세안설비 점검 등록</li>
									</ul><!-- /.breadcrumb -->
								</span>
							</h1>
						</div><!-- /page-header -->
											...
											<div class="GridWrite">       
												...
												<colgroup>
                                                    ...
                                                    <tr class="Row">
                                                        ...
                                                        <td class="Value">
															<input name="UNQ_ID" id="UNQ_ID" title="대분류" type="text" class="TextBox" value="" style="width:200px;" required/>
														</td>
                                                        <th class="Title"><span class="Label">현장위치</span> </th>
                                                        <td class="Value">
															<input name="TH1_ITM_NM" id="TH1_ITM_NM" title="중분류" type="text" class="TextBox" value="" style="width:90%;" required/>
														</td>
                                                    </tr>
                                                </table>
											</div>			
