...
<%@ include file="/WEB-INF/jsp/pels/include/common.jspf"%>
	<script>
		...
		function fncSave () {
			...
			params.TH2_ITM_NM = $('#TH2_ITM_NM').val(); 	// 중분류
			params.TH3_ITM_NM = $('#TH3_ITM_NM').val(); 	// 소분류
			
			$.ajax({
				type: 'POST',
				url: 'Form_Manage_Insert_Ajax.do',
				data: params,
				dataType: 'JSON',
				...
				success: function (resultData) {
					...
					if('true' == resultData.resultCd) {
						...
						location.href = '/Form_Manage_Search.do?FRM_UNQ_KY_VAL=${FRM_UNQ_KY_VAL}';
					} else {
						alert('관리항목 저장에 실패하였습니다.');
						...
						<ul class="breadcrumb">
							<li>
								<a href="#">절차서(서식)관리</a>
                                     ...
                                     <li>
                                         <a href="/Form_Manage_Search.do?FRM_UNQ_KY_VAL=${FRM_UNQ_KY_VAL}">관리항목</a>
                                     </li>
							<li class="active">관리항목 수정</li>
						</ul><!-- /.breadcrumb -->
					</span>
				</h1>
			</div><!-- /page-header -->
                                         ...
                                         <td class="Value">
											<input name="PRCDOC_NM" id="PRCDOC_NM" title="절차서명" type="text" class="TextBox" value="" style="width:90%;" readonly/>
												...
												<input name="UNQ_ID" id="UNQ_ID" title="관리번호" type="text" class="TextBox" value="" style="width:200px;" required/>
                                                     ...
                                                     <th class="Title"><span class="Label">중분류</span> </th>
                                                     <td class="Value">
												<input name="TH1_ITM_NM" id="TH1_ITM_NM" title="대분류" type="text" class="TextBox" value="" style="width:200px;" required/>
											</td>
                                                 </tr>
                                                 <tr class="Row">
                                                     <th class="Title"><span class="Label">중분류</span> </th>
                                                     <td class="Value">
												<input name="TH2_ITM_NM" id="TH2_ITM_NM" title="중분류" type="text" class="TextBox" value="" style="width:90%;" />
											</td>
                                                     <th class="Title"><span class="Label">소분류</span></th>
                                                     <td colspan="3" class="Value">
												<input name="TH3_ITM_NM" id="TH3_ITM_NM" title="소분류" type="text" class="TextBox" value="" style="width:200px;" />
											</td>
                                                 </tr>
                                             </table>
								</div>			
