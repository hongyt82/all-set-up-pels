						...
						<h1>
							...
							<span>
								<ul class="breadcrumb">
									...
									<li>
	                                    <a href="/Form_Atct_Search.do">점검관리</a>
	                                </li>
									<li class="active">관리항목</li>
								</ul><!-- /.breadcrumb -->
							</span>
						</h1>
					</div><!-- /page-header -->
										...
										<table border="0" cellpadding="0" cellspacing="0" class="Outline">
											...
											<tr>
                                                ...
                                                <td class="Value">
                                                    ...
                                                    <input type="text" class="TextBox" name="PRCDOC_NO" id="PRCDOC_NO" style="width:120px;" value="" readonly/>
                                                </td>
										...
										<table cellspacing="0" cellpadding="0" border="0" class="Outline">
											...
											<c:forEach var="formManage" items="${formManageList}" begin="0" end="${formManageList.size()}" step="1">
												<tr class="Item">
													...
													<td align="left">${formManage.TH2_ITM_NM}</td>
													<td align="left">${formManage.TH3_ITM_NM}</td>
