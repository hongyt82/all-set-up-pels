		...
		<div id="navbar" class="navbar navbar-default">
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<ul class="gnb">
						<li class="active"><a href="Main.html" target="mainFrame0">원전 절차수행기록 디지털시스템</a></li>
						<li><a href="#"></a></li>
					</ul>
				</div>
		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							<span class="menu-text">정주기시험</span>
							<b class="arrow fa fa-angle-down"></b>
						</a>
						<b class="arrow"></b>
                        <ul class="submenu">
                            ...
                            <li class="">
                                <a href="javascript:addTab(23, 'Outcome_History_Search', 'Outcome_History_Search.do','시험결과(데이터])');">
                                    	시험결과(데이터])
                                </a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="javascript:addTab(24, 'Outcome_Job_Search', 'Outcome_Job_Search.do','작업전회의 결과 ');">
                                    	작업전회의 결과
                                </a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="javascript:addTab(25, 'Outcome_Dissat_Search', 'Outcome_Dissat_Search.do','불만족보고서 관리');">
                                    	불만족보고서 관리
                                </a>
                                <b class="arrow"></b>
                            </li>
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							<span class="menu-text">점검지A(DB화)</span>
							<b class="arrow fa fa-angle-down"></b>
						</a>
						<b class="arrow"></b>
                        <ul class="submenu">
                            <li class="">
                                <a href="javascript:addTab(31, 'Exam_Monitoring_M', 'Exam_Monitoring.do?PRCDOC_CFY=M','점검 계획 수립');">
                                    	점검 계획 수립
                                </a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="javascript:addTab(32, 'Outcome_Search_M', 'Outcome_Search.do?PRCDOC_CFY=M','점검 결과 관리');">
                                    	점검 결과 관리
                                </a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="javascript:addTab(33, 'Outcome_Ecap_Search.do', 'Outcome_Ecap_Search.do','간편 통지 조회');">
                                    	간편 통지 조회
                                </a>
                                <b class="arrow"></b>
                            </li>
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							<span class="menu-text">점검지B(필기)</span>
							<b class="arrow fa fa-angle-down"></b>
						</a>
						<b class="arrow"></b>
                        <ul class="submenu">
                            <li class="">
                                <a href="javascript:addTab(41, 'Form_Etc_Search', 'Form_Etc_Search.do?FRM_CFY=PDF&MY_DATA=Y','PDF 등록');">
                                    	PDF 등록
                                </a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="javascript:addTab(42, 'Outcome_Etc_Search', 'Outcome_Etc_Search.do','필기 결과 관리');">
                                    	필기 결과 관리
                                </a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="javascript:addTab(43, 'Form_Etc_Search2', 'Form_Etc_Search.do?FRM_CFY=PDF&MY_DATA=N','부서 PDF 조회');">
                                    	부서 PDF 조회
                                </a>
                                <b class="arrow"></b>
                            </li>
                    ...
                    <li class="">
                        ...
                        <ul class="submenu">
                            <li class="">
                                <a href="javascript:addTab(51, 'Board_Search_A', 'Board_Search.do?GRUP_CFY_CD=A','고장신고 및 개선의견');">
                                    	고장신고 및 개선의견
                                </a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="javascript:addTab(52, 'Board_Search_B', 'Board_Search.do?GRUP_CFY_CD=B','자료실');">
										자료실
								</a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="javascript:addTab(53, 'Board_Search_C', 'Board_Search.do?GRUP_CFY_CD=C','공지사항');">
										공지사항
								</a>
                                <b class="arrow"></b>
                            </li>
                    ...
                    <li class="">
                        ...
                        <ul class="submenu">
                            <li class="">
                                <a href="javascript:addTab(61, 'Proc_Search_P', 'Proc_Search.do?PRCDOC_CFY=P','정주기시험 서식');">
										정주기시험
								</a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="javascript:addTab(62, 'Proc_Search_M', 'Proc_Search.do?PRCDOC_CFY=M','점검지 서식');">
										점검지
								</a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="javascript:addTab(63, 'Job_Form_Search', 'Form_Etc_Search.do?FRM_CFY=JOB','작업전회의 서식');">
                                    	작업전회의
                                </a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="javascript:addTab(64, 'Form_Draw_Search', 'Form_Draw_Search.do','도면/절차서 연계');">
                                    	도면/절차서 연계
                                </a>
                                <b class="arrow"></b>
                            </li>
                    ...
                    <li class="">
                        ...
                        <!-- 
                            ...
                            <li class="">
                                <a href="javascript:addTab(71, 'Grade_Search', 'Grade_Search.do','권한관리');">
                                    	권한관리
                                </a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="javascript:addTab(72, 'Message_Search', 'Message_Search.do','알림창 이력');">
                                    	알림창 이력
                                </a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
		                       ...
		                       <ul class="submenu">
		                            <li class="">
		                                <a href="javascript:addTab(74, 'StatsConnect_Search', 'StatsConnect_Search.do','접속자 통계');">
		                                    	- 접속자 통계
		                                </a>
		                                <b class="arrow"></b>
		                            </li>
		                            <li class="">
		                                <a href="javascript:addTab(75, 'StatsExam_Search', 'StatsExam_Search.do','정주기시험 통계');">
		                                    	- 정주기시험 통계
		                                </a>
		                                <b class="arrow"></b>
		                            </li>
                            ...
                            <li class="">
                                <a href="javascript:addTab(73, 'Sign_Search', 'Sign_Search.do','결재사인관리');">
                                    	결재사인관리
                                </a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
		                       ...
		                       <ul class="submenu">
		                            <li class="">
		                                <a href="javascript:addTab(76, 'Table_Search', 'Table_Search.do','테이블 구조조회');">
		                                    	- 테이블 구조조회
		                                </a>
		                                <b class="arrow"></b>
		                            </li>
		                            <li class="">
		                                <a href="javascript:addTab(77, 'Table_Data_Search', 'Table_Data_Search.do','테이블별 데이터 현황');">
		                                    	- 테이블별 데이터 현황
		                                </a>
		                                <b class="arrow"></b>
		                            </li>
