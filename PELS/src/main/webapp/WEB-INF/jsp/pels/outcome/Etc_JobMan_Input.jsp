		...
		<div class="page-content">
			<div class="page-content-area">
				...
				<div class="page-header">
					<h1>
						<span class="title">작업전회의 수기등록</span>
						<span>
							<ul class="breadcrumb">
								<li>
									<a href="#">작업전회의</a>
									...
									<div class="GridWrite">       
										...
										<colgroup>
                                            ...
                                            <tr class="Row">
	                                            ...
	                                            <td class="Value">
													<input name="MTNG_DY" id="MTNG_DY" title="회의일자" type="text" class="TextBox" value="" style="width:100px;" required readonly/>
                                                 ...
                                                 <td class="Value">
													<input name="MTNG_HSMPR_ID" id="MTNG_HSMPR_ID" title="주기" type="text" class="TextBox" value="" style="width:100px;"/>
											  	</td>
                                            </tr>
                                        	<tr class="Row">
                                                <th class="Title"><span class="Label Req">회의장소</span> </th>
                                                <td class="Value">
													<input name="MTNG_PLC_NM" id="MTNG_PLC_NM" type="text" class="TextBox" value="" style="width:90%;" />
											  	</td>
		                                		<th class="Title"><span class="Label Req">호기</span></th>
		                                		<td class="Value">
													<input name="PRCDOC_VER_NO" id="PRCDOC_VER_NO" title="호기" type="text" class="TextBox" value="" style="width:10%;"/>
							  					</td>
                                            </tr>
                                             <tr class="Row">
                                                <th class="Title"><span class="Label Req">작업부서명</span></th>
                                                <td class="Value">
													<input name="WRK_SCTN_NM" id="WRK_SCTN_NM" title="주기" type="text" class="TextBox" value="" style="width:90%;"/>
											 	</td>
                                                <th class="Title"><span class="Label Req">오더번호</span> </th>
                                                <td class="Value">
													<input name="WRKOR_NO" id="WRKOR_NO" type="text" class="TextBox" value="" style="width:200px;" />
											  	</td>
                                             </tr>
                                             <tr class="Row">
                                                <th class="Title"><span class="Label Req">작업명</span> </th>
                                                <td class="Value">
													<input name="WRK_NM" id="WRK_NM" type="text" class="TextBox" value="" style="width:90%;" />
											  	</td>
                                                <th class="Title"><span class="Label Req">작업범위</span></th>
                                                <td class="Value">
													<input name="WRK_TRGT_NM" id="WRK_TRGT_NM" title="주기" type="text" class="TextBox" value="" style="width:90%;"/>
													<input name="FRM_UNQ_KY_VAL" id="FRM_UNQ_KY_VAL" title="주기" type="hidden" class="TextBox" value="0" style="width:90%;"/>
											  	</td>
                                             ...
                                             <tr class="Row">
                                                ...
                                                <td class="Value">
                                                <select name="FRM_CFY" id="FRM_CFY" required>
	                                                <option value="MAN_REP">정비작업전회의</option>
	                                                <option value="MAN_GEN">일반작업전회의</option>
                                                </select>
											  	</td>
