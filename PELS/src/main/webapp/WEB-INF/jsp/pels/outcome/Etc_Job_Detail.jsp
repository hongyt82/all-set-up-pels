...
<%@ include file="/WEB-INF/jsp/pels/include/common.jspf"%>
	...
	<script>
		...
		function fncSave () {
			...
			formData.append('UNQ_KY_VAL', $('#UNQ_KY_VAL').val());
			
			$.ajax({
				type: 'POST',
				enctype: 'multipart/form-data',
				url: 'Etc_Job_Update_Ajax.do',
				data: formData,
				processData: false,
				contentType: false,
				success: function (resultData) {
					...
					if('true' == resultData.resultCd) {
						...
						location.href = '/Etc_Job_Search.do';	
					} else {
						alert('저장에 실패하였습니다.');
									...
									<div class="GridWrite">       
										...
										<colgroup>
                                            ...
                                            <tr class="Row">
	                                            ...
	                                            <td class="Value">
													<input name="MTNG_DY" id="MTNG_DY" title="회의일자" type="text" class="TextBox" value="${EtcJobFormDetail.FM_MTNG_DY}" style="width:100px;" required readonly/>
                                                 ...
                                                 <td class="Value">
													<input name="MTNG_HSMPR_ID" id="MTNG_HSMPR_ID" title="주기" type="text" class="TextBox" value="${EtcJobFormDetail.MTNG_HSMPR_ID}" style="width:100px;"/>
											  	</td>
                                            </tr>
                                        	<tr class="Row">
                                                <th class="Title"><span class="Label Req">회의장소</span> </th>
                                                <td class="Value">
													<input name="MTNG_PLC_NM" id="MTNG_PLC_NM" type="text" class="TextBox" value="${EtcJobFormDetail.MTNG_PLC_NM}" style="width:90%;" />
											  	</td>
		                                		<th class="Title"><span class="Label Req">호기</span></th>
		                                		<td class="Value">
													<input name="PRCDOC_VER_NO" id="PRCDOC_VER_NO" title="호기" type="text" class="TextBox" value="${EtcJobFormDetail.PRCDOC_VER_NO}" style="width:10%;"/>
							  					</td>
                                            </tr>
                                             <tr class="Row">
                                                <th class="Title"><span class="Label Req">작업부서명</span></th>
                                                <td class="Value">
													<input name="WRK_SCTN_NM" id="WRK_SCTN_NM" title="주기" type="text" class="TextBox" value="${EtcJobFormDetail.WRK_SCTN_NM}" style="width:90%;"/>
											 	</td>
                                                <th class="Title"><span class="Label Req">오더번호</span> </th>
                                                <td class="Value">
													<input name="WRKOR_NO" id="WRKOR_NO" type="text" class="TextBox" value="${EtcJobFormDetail.WRKOR_NO}" style="width:200px;" />
											  	</td>
                                             </tr>
                                             <tr class="Row">
                                                <th class="Title"><span class="Label Req">작업명</span> </th>
                                                <td class="Value">
													<input name="WRK_NM" id="WRK_NM" type="text" class="TextBox" value="${EtcJobFormDetail.WRK_NM}" style="width:90%;" />
											  	</td>
                                                <th class="Title"><span class="Label Req">작업범위</span></th>
                                                <td class="Value">
													<input name="WRK_TRGT_NM" id="WRK_TRGT_NM" title="주기" type="text" class="TextBox" value="${EtcJobFormDetail.WRK_TRGT_NM}" style="width:90%;"/>
													<input name="FRM_UNQ_KY_VAL" id="FRM_UNQ_KY_VAL" title="주기" type="hidden" class="TextBox" value="${EtcJobFormDetail.FRM_UNQ_KY_VAL}" style="width:90%;"/>
													<input name="FRM_CFY" id="FRM_CFY" title="주기" type="hidden" class="TextBox" value="${EtcJobFormDetail.FRM_CFY}" style="width:90%;"/>
													<input name="UNQ_KY_VAL" id="UNQ_KY_VAL" title="주기" type="hidden" class="TextBox" value="${EtcJobFormDetail.UNQ_KY_VAL}" style="width:90%;"/>
											  	</td>
                                             </tr>
                                         </table>
									</div>			
