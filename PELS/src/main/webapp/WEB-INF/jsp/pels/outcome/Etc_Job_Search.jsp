...
<%@ include file="/WEB-INF/jsp/pels/include/common.jspf"%>
	...
	<script>
		...
		function fnFormLDM() {
			...
			if (chkCnt == 0) {
				alert('LDM 전송할 자료를 선택하여 주십시오.')
				return
			} else if (chkCnt != 1) {
				alert('LDM 전송을 위해서는 하나의 자료만 선택되어야합니다.')
				return
			}
												...
												<c:forEach var="etcOutcome" items="${EtcJobList}" begin="0" end="${EtcJobList.size()}" step="1">
													<tr class="Item">
														...
														<c:if test="${etcOutcome.FRM_CFY eq 'MAN_REP' or etcOutcome.FRM_CFY eq 'MAN_GEN'}">
															<td align="center"><a href="/upload/GE_MP_JOB_S/${etcOutcome.ATFL_PHCL_NM}"><img src="/resources/themes/QuartzLight/Skins/Image/pdf.png" height="21px;"></a></td>
														</c:if>
														<c:if test="${etcOutcome.FRM_CFY eq 'GEN'}">
															<td align="center"><a href="javascript:MM_openBrWindow('OzdViewer.do?ATFL_PHCL_NM=${etcOutcome.ATFL_PHCL_NM}&ATFL_PHCL_NM_OZR=${etcOutcome.ATFL_PHCL_NM_GEN}','ozd','width=1000,height=800');"><img src="/resources/themes/QuartzLight/Skins/Image/ozr.png" height="21px;"></a></td>
														</c:if>
														<c:if test="${etcOutcome.FRM_CFY eq 'REP'}">
															<td align="center"><a href="javascript:MM_openBrWindow('OzdViewer.do?ATFL_PHCL_NM=${etcOutcome.ATFL_PHCL_NM}&ATFL_PHCL_NM_OZR=${etcOutcome.ATFL_PHCL_NM_REP}','ozd','width=1000,height=800');"><img src="/resources/themes/QuartzLight/Skins/Image/ozr.png" height="21px;"></a></td>
														</c:if>
