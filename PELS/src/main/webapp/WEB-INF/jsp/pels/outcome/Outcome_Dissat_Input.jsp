...
<%@ include file="/WEB-INF/jsp/pels/include/common.jspf"%>
	<script>
		...
		function fncSave () {
			...
			$.ajax({
				type: 'POST',
				url: 'Outcome_Dissat_Insert_Ajax.do',
				data: params,
				dataType: 'JSON',
								...
								<div class="GridWrite">       
									...
									<colgroup>
                                       ...
                                       <tr class="Row">
                                           ...
                                           <td class="Value">
											<input name="SAP_SNO" id="SAP_SNO" title="일련번호" type="text" class="TextBox" value="" style="width:200px;" required />
										</td>
                                           <th class="Title"><span class="Label Req">발생일시</span> </th>
                                           <td class="Value">
                                           <input name="OCCR_DY" id="OCCR_DY" type="text" style="width:80px;" class="TextBox" value="" onkeypress="fnOnKeyPress();"/>
                                       ...
                                       <tr class="Row">
                                           ...
                                           <td class="Value">
											<input name="PRCDOC_NO" id="PRCDOC_NO" title="식별자" type="text" class="TextBox" value="${PRCDOC_NO}" style="width:200px;" required />
										</td>
                                           <th class="Title"><span class="Label Req">절차서제목</span></th>
                                           <td class="Value">
											<input name="PRCDOC_NM" id="PRCDOC_NM" title="식별자" type="text" class="TextBox" value="${PRCDOC_NM}" style="width:100%;" required />
										</td>
                                       </tr>
                                       <tr class="Row">
                                           <th class="Title"><span class="Label Req">시험근거</span></th>
                                           <td class="Value" colspan="3">
											<input name="TST_BSS_CTT" id="TST_BSS_CTT" title="식별자" type="text" class="TextBox" value="" style="width:100%;" required />
										</td>
                                       </tr>
                                       <tr class="Row">
                                           	<th class="Title"><span class="Label Req">시험주관부서</span></th>
                                           	<td class="Value">
											<input name="TST_HMDPT_NM" id="TST_HMDPT_NM" title="식별자" type="text" class="TextBox" value="" style="width:100%;" required />
											</td>
                                       ...
                                       <tr class="Row">
                                           ...
                                           <td class="Value" colspan="3">
											<textarea name="TST_DSSTN_CTT" id="TST_DSSTN_CTT" rows="5" cols="124"></textarea>
										</td>
                                       </tr>
                                       <tr class="Row">
                                           <th class="Title"><span class="Label Req">시험주관부서<br>조치사항</span></th>
                                           <td class="Value" colspan="3">
											<textarea name="MNMT_CTT" id="MNMT_CTT" rows="5"  class="" cols="124"></textarea>
										</td>
                                       </tr>
                                       <tr class="Row">
                                           <th class="Title"><span class="Label Req">통지번호</span></th>
                                           <td class="Value">
											<input name="NOTN_NO" id="NOTN_NO" title="식별자" type="text" class="TextBox" value="" style="width:90%;" required />
										</td>
                                           <th class="Title"><span class="Label Req">발행일</span></th>
                                           <td class="Value">
                                           <input name="PBLSH_DY" id="PBLSH_DY" type="text" style="width:80px;" class="TextBox" value="" onkeypress="fnOnKeyPress();"/>
                                       ...
                                       <tr class="Row">
                                           ...
                                           <td class="Value" colspan="3">
											<textarea  name="TSP_CTT" id="TSP_CTT" rows="5" cols="124"></textarea>
										</td>
                                       </tr>
                                        </table>
									</div>			
