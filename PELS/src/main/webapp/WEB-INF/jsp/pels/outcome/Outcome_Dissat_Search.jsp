...
<div class="page-content">
	<div class="page-content-area">
		...
		<div class="page-header">
			<h1>
				<span class="title">불만족보고서 관리</span>
				<span>
					<ul class="breadcrumb">
						<li>
							<a href="#">정주기시험</a>
						</li>
						<li class="active">불만족보고서 관리</li>
					</ul><!-- /.breadcrumb -->
				</span>
			</h1>
		</div><!-- /page-header -->
							...
							<table cellspacing="0" cellpadding="0" border="0" class="Outline">
								...
								<c:forEach var="outcome" items="${outcomeList}" begin="0" end="${outcomeList.size()}" step="1">
									<tr class="Item">
										...
										<td align="left"><a href="/Outcome_Main_History_Search.do?URL=Outcome_Search.do&TST_UNQ_KY_VAL=${outcome.TST_UNQ_KY_VAL}&FRM_UNQ_KY_VAL=${outcome.FRM_UNQ_KY_VAL}&PRCDOC_CFY=${PRCDOC_CFY}"">${outcome.TITL_NM}</a></td>
										...
										<c:choose>
											...
											<c:otherwise>
												<td align="center">
													<a  class="SubButton" href="javascript:MM_openBrWindow('OzdViewer.do?ATFL_PHCL_NM=${outcome.JOB_FNAME1}','','width=1000,height=800');"><span class="Text">보기</span></a>
												</td>
											</c:otherwise>
										</c:choose>														
										<c:choose>
