...
<%@ include file="/WEB-INF/jsp/pels/include/common.jspf"%>
	<script>
		...
		function fncSave () {
			...
			params.UNQ_ID = $('#UNQ_ID').val();
			params.TH1_ITM_NM = $('#TH1_ITM_NM').val();
			params.RMK_NM = $('#RMK_NM').val();
			
			$.ajax({
				type: 'POST',
				url: 'Outcome_ItemMNT_Update_Ajax.do',
				data: params,
				dataType: 'JSON',
...
<body class="no-skin real-skin">
	...
	<input name="UNQ_KY_VAL" id="UNQ_KY_VAL" title="서식고유키값" type="hidden" class="TextBox" value="${UNQ_KY_VAL}"/>
	...
	<div class="page-content">
		<div class="page-content-area">
			...
			<div class="page-header">
				<h1>
					<span class="title">${examDetail.ATCT_NM} 수정</span>
					<span>
						<ul class="breadcrumb">
							<li>
								<a href="#">점검지A(DB화)</a>
							...
							<li class="active">${examDetail.ATCT_NM} [${examDetail.TITL_NM}] 수정</li>
						</ul><!-- /.breadcrumb -->
					</span>
				</h1>
			</div><!-- /page-header -->
                                         ...
                                         <td class="Value">
											${examDetail.ATCT_NM} [${examDetail.TITL_NM}]
                                                 ...
                                                 <tr class="Row">
                                                     ...
                                                     <td class="Value">
												<input name="UNQ_ID" id="UNQ_ID" title="관리번호" type="text" class="TextBox" value="${ItemMntDetail.UNQ_ID}" style="width:200px;" required/>
											</td>
                                                     <th class="Title"><span class="Label Req">감독부서</span> </th>
                                                     <td class="Value">
												<input name="TH1_ITM_NM" id="TH1_ITM_NM" title="감독부서" type="text" class="TextBox" value="${ItemMntDetail.TH1_ITM_NM}" style="width:200px;" required/>
											</td>
											</tr>
                                                 <tr class="Row">
                                                     <th class="Title"><span class="Label">조치필요사항</span></th>
                                                     <td class="Value" colspan=3>
												<input name="RMK_NM" id="RMK_NM" title="조치필요사항" type="text" class="TextBox" value="${ItemMntDetail.RMK_NM}" style="width:200px;"/>
											</td>
											</tr>
                                             </table>
									</div>			
