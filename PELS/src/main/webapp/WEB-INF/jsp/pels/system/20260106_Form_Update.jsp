										...
										<colgroup>
											...
											<col style="width:40%" />
                                                  ...
                                                  <tr class="Row">
                                                      ...
                                                      <td class="Value">
														<input name="ATFL_TITL_NM1" id="ATFL_TITL_NM1" title="서식1 제목" type="text" class="TextBox" value="${formList[0].ATFL_TITL_NM1}" style="width:95%;" required/>
													  </td>
                                                      ...
                                                      <td class="Value">
                                                      	<c:if test="${not empty formList[0].ATFL_PHCL_NM1}">
	                                                      	<a href="javascript:MM_openBrWindow('OzrViewer.do?ATFL_PHCL_NM=${formList[0].ATFL_PHCL_NM1}','','width=1000,height=800');">
                                                  ...
                                                  <tr class="Row">
                                                      ...
                                                      <td class="Value">
														<input name="ATFL_TITL2" id="ATFL_TITL_NM2" title="서식2 제목" type="text" class="TextBox" value="${formList[0].ATFL_TITL_NM2}" style="width:95%;" />
													  </td>
                                                  ...
                                                  <tr class="Row">
                                                      ...
                                                      <td class="Value">
														<input name="ATFL_TITL_NM3" id="ATFL_TITL_NM3" title="서식3 제목" type="text" class="TextBox" value="${formList[0].ATFL_TITL_NM3}" style="width:95%;" />
													  </td>
                                                  ...
                                                  <tr class="Row">
                                                      ...
                                                      <td class="Value">
														<input name="ATFL_TITL_NM4" id="ATFL_TITL_NM4" title="서식4 제목" type="text" class="TextBox" value="${formList[0].ATFL_TITL_NM4}" style="width:95%;" />
													  </td>
                                                      ...
                                                      <td class="Value">
                                                      	<c:if test="${not empty formList[0].ATFL_PHCL_NM4}">
                                                      		<a href="javascript:MM_openBrWindow('OzrViewer.do?ATFL_PHCL_NM=${formList[0].ATFL_PHCL_NM4}','','width=1000,height=800');">
																<img src="/resources/themes/QuartzLight/Skins/Image/ozr.png" height="21px;">
															</a>
                                                  ...
                                                  <tr class="Row">
                                                      ...
                                                      <td class="Value">
														<input name="ATFL_TITL_NM5" id="ATFL_TITL_NM5" title="서식5 제목" type="text" class="TextBox" value="${formList[0].ATFL_TITL_NM5}" style="width:95%;" />
													  </td>
                                                      ...
                                                      <td class="Value">
                                                      	<c:if test="${not empty formList[0].ATFL_PHCL_NM5}">
                                                      		<a href="javascript:MM_openBrWindow('OzrViewer.do?ATFL_PHCL_NM=${formList[0].ATFL_PHCL_NM5}','','width=1000,height=800');">
																<img src="/resources/themes/QuartzLight/Skins/Image/ozr.png" height="21px;">
															</a>
													...
													<tr class="Item">
														...
														<td align="left">
                                                      	<c:if test="${not empty form.ATFL_PHCL_NM1}">
                                                      		<a href="javascript:MM_openBrWindow('OzrViewer.do?ATFL_PHCL_NM=${form.ATFL_PHCL_NM1}','','width=1000,height=800');">
																<img src="/resources/themes/QuartzLight/Skins/Image/ozr.png" height="21px;">
															</a>
                                                      	</c:if>
														${form.ATFL_TITL_NM1}
														...
														<td align="left">
                                                      	<c:if test="${not empty form.ATFL_PHCL_NM2}">
                                                      		<a href="javascript:MM_openBrWindow('OzrViewer.do?ATFL_PHCL_NM=${form.ATFL_PHCL_NM2}','','width=1000,height=800');">
																<img src="/resources/themes/QuartzLight/Skins/Image/ozr.png" height="21px;">
															</a>
                                                      	</c:if>
														${form.ATFL_TITL_NM2}
														...
														<td align="left">
                                                      	<c:if test="${not empty form.ATFL_PHCL_NM3}">
                                                      		<a href="javascript:MM_openBrWindow('OzrViewer.do?ATFL_PHCL_NM=${form.ATFL_PHCL_NM3}','','width=1000,height=800');">
																<img src="/resources/themes/QuartzLight/Skins/Image/ozr.png" height="21px;">
															</a>
                                                      	</c:if>
														${form.ATFL_TITL_NM3}
														...
														<td align="left">
                                                      	<c:if test="${not empty form.ATFL_PHCL_NM4}">
                                                      		<a href="javascript:MM_openBrWindow('OzrViewer.do?ATFL_PHCL_NM=${form.ATFL_PHCL_NM4}','','width=1000,height=800');">
																<img src="/resources/themes/QuartzLight/Skins/Image/ozr.png" height="21px;">
															</a>
                                                      	</c:if>
														${form.ATFL_TITL_NM4}
														...
														<td align="left">
                                                      	<c:if test="${not empty form.ATFL_PHCL_NM5}">
                                                      		<a href="javascript:MM_openBrWindow('OzrViewer.do?ATFL_PHCL_NM=${form.ATFL_PHCL_NM5}','','width=1000,height=800');">
																<img src="/resources/themes/QuartzLight/Skins/Image/ozr.png" height="21px;">
															</a>
                                                      	</c:if>
														${form.ATFL_TITL_NM5}
