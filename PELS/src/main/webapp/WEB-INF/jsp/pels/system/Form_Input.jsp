										...
										<colgroup>
											...
											<col style="width:70%" />
                                                 ...
                                                 <tr class="Row">
                                                      ...
                                                      <td class="Value">
														<input name="ATFL_TITL_NM1" id="ATFL_TITL_NM1" title="제목" type="text" class="TextBox" value="절차서 PDF" style="width:200px;" required />
													  </td>
                                                      <th class="Title"><span class="Label Req">양식 첨부(PDF)</span></th>
                                                      <td class="Value"><input name="ATFL_FILE1" id="ATFL_FILE1" title="양식 파일(PDF)" type="file" accept=".pdf" required /></td>
                                                  </tr>                    
                                                  <!--                               
                                                  <tr class="Row">
                                                      <th class="Title"><span class="Label">서식1 제목</span></th>
                                                      <td class="Value">
														<input name="ATFL_TITL_NM2" id="ATFL_TITL_NM2" title="서식1 제목" type="text" class="TextBox" value="" style="width:200px;" />
													  </td>
                                                      <th class="Title"><span class="Label">서식1 첨부</span></th>
                                                      <td class="Value"><input name="ATFL_FILE2" id="ATFL_FILE2" title="서식1 파일" type="file" /></td>
                                                  </tr>
                                                  <tr class="Row">
                                                      <th class="Title"><span class="Label ">서식2 제목</span></th>
                                                      <td class="Value">
														<input name="ATFL_TITL3" id="ATFL_TITL_NM3" title="서식2 제목" type="text" class="TextBox" value="" style="width:200px;" />
													  </td>
