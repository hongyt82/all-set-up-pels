...
<body class="no-skin real-skin">
	<form id="form" name="form" method="post">
		<input name="PPCD" id="PPCD" type="hidden" value="${Detail.PPCD}"/>
								...
								<div class="ContentPanel">
									<div class="GridWrite">       
                                        ...
                                        <tr class="Row">
                                            ...
                                            <td class="Value">
												<input name="USER_ID" id="USER_ID" title="사번" type="text" class="TextBox" value="${Detail.USER_ID}" style="width:100px;" readonly required />
											</td>
                                            <th class="Title"><span class="Label Req">사용자명</span></th>
                                            <td class="Value">
												<input name="USER_NM" id="USER_NM" title="성명" type="text" class="TextBox" value="${Detail.USER_NM}" style="width:100px;" readonly required />
											</td>
                                        </tr>
                                        <tr class="Row">
                                            <th class="Title"><span class="Label ">부서명</span></th>
                                            <td class="Value">
											<input name="RELTN_SCTN_NM" id="RELTN_SCTN_NM" title="부서명" type="text" class="TextBox" value="${Detail.RELTN_SCTN_NM}" style="width:500px;" readonly  />
											</td>
	                                        ...
	                                        <td class="Value">
                                                 ...
                                                 <tr class="Row">
													...
													<input name="RMK" id="RMK" title="qlrh" type="text" class="TextBox" value="${Detail.RMK}" style="width:90%;"  />
													</td>
                                              </table>
									</div>			
