...
<%
	...
	String CHCK_STRT_DT15 = localDate.withDayOfMonth(15) + "";
	String CHCK_STRT_DT16 = localDate.withDayOfMonth(16) + "";
	String CHCK_END_DT = localDate.withDayOfMonth(localDate.lengthOfMonth()) + "";
	System.out.println("CHCK_STRT_DT =" + CHCK_STRT_DT);
	System.out.println("CHCK_STRT_DT15 =" + CHCK_STRT_DT15);
	System.out.println("CHCK_STRT_DT16 =" + CHCK_STRT_DT16);
	System.out.println("CHCK_END_DT =" + CHCK_END_DT);
	
%>
	<script>
		$(document).ready(function () {
			$('#RRD_CFY').val('${Detail.RRD_CFY}');
			$('#MNTRG_YN').val('${Detail.MNTRG_YN}');
			$('#APRV_YN_CFY').val('${Detail.APRV_YN_CFY}');
			checkAPRV_YN_CFY();
			if('${Detail.AUCR_YN}' == 'Y')
				$('input[id=AUCR_YN]').prop('checked', true);
			$('#APRV_STEP_CFY').val('${Detail.APRV_STEP_CFY}');
...
<body class="no-skin real-skin">
	...
	<input name="PRCDOC_UNQ_KY_VAL" id="PRCDOC_UNQ_KY_VAL" title="절차서고유번호" type="hidden" class="TextBox" value="${Detail.PRCDOC_UNQ_KY_VAL}" />
	<input name="PRCDOC_CFY" id="PRCDOC_CFY" title="절차서고유번호" type="hidden" class="TextBox" value="${PRCDOC_CFY}" />
		<div class="page-content">
			<div class="page-content-area">
				<!-- #ection:basics/page-header -->
				<div class="page-header">
					<h1>
						<span class="title">절차서 수정</span>
						<span>
							<ul class="breadcrumb">
								<li>
									<a href="#">시스템관리</a>
								...
								<div class="ContentPanel">
									<div class="GridWrite">       
                                        ...
                                        <tr class="Row">
                                            ...
                                            <td class="Value">
												<input name="PRCDOC_NO" id="PRCDOC_NO" title="절차서번호" type="text" class="TextBox" value="${Detail.PRCDOC_NO}" style="width:200px;" required />
                                            </td>
                                            <th class="Title"><span class="Label Req">절차서명</span></th>
                                            <td class="Value">
												<input name="PRCDOC_NM" id="PRCDOC_NM" title="절차서명" type="text" class="TextBox" value="${Detail.PRCDOC_NM}" style="width:90%;" required />
                                            </td>
                                        </tr>
                                        <tr class="Row">
                                             <th class="Title"><span class="Label Req">문서유형</span></th>
                                             <td class="Value">
												<input name="DOC_TYP" id="DOC_TYP" title="문서유형" type="text" class="TextBox" value="${Detail.DOC_TYP}" style="width:100px;" required />
                                             </td>
                                             <th class="Title"><span class="Label Req">문서부분번호</span> </th>
                                             <td class="Value">
                                             	<input name="DOC_PART_NO" id="DOC_PART_NO" title="문서부분번호" type="text" class="TextBox" value="${Detail.DOC_PART_NO}" style="width:80px;" required />
											 </td>
                                        </tr>
                                  		<tr class="Row">
                                            <th class="Title"><span class="Label ">기능위치</span></th>
                                            <td class="Value">
												<input name="FNCLC_ID" id="FNCLC_ID" title="기능위치" type="text" class="TextBox" value="${Detail.FNCLC_ID}" style="width:200px;"  />
											</td>
                                        ...
                                        <tr class="Row">
	                                        ...
	                                        <td class="Value"  colspan=3>
												<input name="ATCT_NM" id="ATCT_NM" title="붙임명" type="text" class="TextBox" value="${Detail.ATCT_NM}" style="width:90%;" required />
											</td>
                                        </tr>
                                        </c:if>
                                    </table>
