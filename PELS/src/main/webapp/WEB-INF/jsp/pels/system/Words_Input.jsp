...
<%@ include file="/WEB-INF/jsp/pels/include/common.jspf"%>
	<script>
		...
		function fncSave () {
			...
			params.WRGD_CTT = $('#WRGD_CTT').val();
			
			$.ajax({
				type: 'POST',
				url: 'Words_Insert_Ajax.do',
				data: params,
				dataType: 'JSON',
	...
	<div class="page-content">
		<div class="page-content-area">
			...
			<div class="page-header">
				<h1>
					<span class="title">자주쓰는문구 등록</span>
					<span>
						<ul class="breadcrumb">
							<li>
								<a href="#">절차서(서식)관리</a>
							...
							<li class="">자주쓰는문구관리</li>
							<li class="active">자주쓰는문구 등록</li>
						</ul><!-- /.breadcrumb -->
					</span>
				</h1>
							...
							<div class="ContentPanel">
								<div class="GridWrite">       
									...
									<colgroup>
                                       ...
                                       <tr class="Row">
                                           <th class="Title"><span class="Label Req">자주쓰는문구</span> </th>
                                           <td class="Value">
											<input name="WRGD_CTT" id="WRGD_CTT" title="자주쓰는문구" type="text" class="TextBox" value="" style="width:90%;" required />
										</td>
                                       </tr>
                                        </table>
									</div>			
