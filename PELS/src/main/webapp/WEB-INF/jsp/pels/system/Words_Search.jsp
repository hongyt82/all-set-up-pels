...
<%@ include file="/WEB-INF/jsp/pels/include/common.jspf"%>
	<script>
		...
		function fnDelete () {
			...
			params.WRGD_CTT = chkParams;
			
			$.ajax({
				type: 'POST',
				url: 'Words_Delete_Ajax.do',
				data: params,
				dataType: 'JSON',
				...
				<div class="page-content">
					<div class="page-content-area">
						...
						<div class="page-header">
							<h1>
								<span class="title">자주쓰는문구관리</span>
								<span>
									<ul class="breadcrumb">
										<li>
											<a href="#">절차서(서식)관리</a>
									...
									<div class="ContentPanel">
										<div class="StatusGrid">
											<table cellspacing="0" cellpadding="0" border="0" class="Outline">
												...
												<c:forEach var="words" items="${wordsList}" begin="0" end="${wordsList.size()}" step="1">
													<tr class="Item">
														<td align="center" style="font-weight:bold"><input name="CHK_ITEM" id="CHK_ITEM" type="checkbox" onclick="checkOnlyOne(this)" value="${words.WRGD_CTT}"></td>
														<td>${words.WRGD_CTT}</td>
														<td align="center">${words.REGPR_NM}</td>
														<td align="center">${words.FM_RG_DT}</td>
													</tr>
												</c:forEach>
												<c:if test="${wordsList.size() eq 0}">
													<tr class="Item">
														<td colspan="4" style="text-align: center;">조회된 자료가 없습니다.</td>
													</tr>
												</c:if>
											</table>
