...
export function ViewerFooter({
  ...
  return (
    <footer
      className="viewer-footer h-[32px] border-t border-emerald-900 flex items-center justify-between shadow-sm flex-shrink-0 overflow-hidden px-2 bg-[#003a34] min-w-[800px]"
